...
YouTube title = catchy premise (for CTR).
SEO keywords = go in the video description + spoken content.
...
- `"[Common thing] is not the problem. [Surprising real cause] is."`
...
**SEO keywords (for description + spoken content):**
`prop firm challenge, funded account, FTMO, TopStep, daily drawdown limit, funded trader`

**Core argument:**
Most traders who fail prop firm challenges have a legitimate edge. They fail because the challenge environment creates a specific psychological pressure scenario — time pressure + daily drawdown limits + "exam feeling" — that triggers exactly the behavioral cascade that causes blowups. Discipline doesn't fix this because willpower degrades under the exact conditions the challenge creates.
...
**SEO keywords:** `stop loss, stop loss manipulation, moving stop loss, trading psychology`
...
**SEO keywords:** `revenge trading, how to stop revenge trading, trading psychology, emotional trading`

**Core argument:** Revenge trading is not random. It has a fixed 4-stage sequence, each stage with measurable behavioral signals. If you know the stages, you can intervene at Stage 2 instead of waking up at Stage 4 when the damage is done.

**Status:** Script ready → `01-anatomy-of-revenge-trade.md`
...
**SEO keywords:** `trading discipline, trading mindset, trading psychology books, trading rules`

**Core argument:** Discipline is a finite resource that degrades under stress. The traders who rely on it most are the ones most vulnerable when it runs out. Every system that works — from professional risk management to prop firm rules — removes the decision from the individual, not demands more of them.

**High potential:** Directly challenges Trading in the Zone / Mark Douglas consensus → controversy = views.
...
**SEO keywords:** `tilt trading, trading tilt, how to stop tilting, emotional trading futures`

**Core argument:** "Tilt" is thrown around but never defined precisely. It's actually a specific cluster of 5 measurable behaviors — each one individually not catastrophic, but together they predict a blowup within the next 30-60 minutes of trading with high reliability.

**Meridian mention:** PSI is a tilt measurement system.
...
**SEO keywords:** `overtrading, how to stop overtrading, trading too much, futures overtrading`

**Core argument:** Overtrading under pressure is a compulsive behavior driven by unresolved loss aversion — the same mechanism as compulsive gambling. Rules don't stop compulsions. External structural limits do.
...
**SEO keywords:** `blown trading account, blowing up trading account, trading account recovery`

**Core argument:** There is a consistent behavioral sequence — a "pre-blowup pattern" — that appears in the hour before catastrophic losses. It involves an accelerating combination of size spikes, rushed entries, and stop-moving. It's been the same pattern across every blown account we've analyzed.
