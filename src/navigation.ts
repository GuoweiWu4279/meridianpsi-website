...
export const footerData = {
  ...
  ntDisclaimers: `
    ...
    <p><strong>Trademark Notice:</strong> NinjaTrader&reg; is a registered trademark of NinjaTrader LLC. Meridian is an independent third-party add-on for NinjaTrader 8 and is not affiliated with, endorsed by, or supported by NinjaTrader LLC.</p>
  `,
};
