...
This notice explains, in plain language, the anonymized data Meridian collects to improve
the product and to conduct research on trading discipline. It supplements our
...
- Your name, email, or any contact details.
- Broker or NinjaTrader credentials, account numbers, or login information.
- Card details, funds, balances, or withdrawal information.
- Any directly personally-identifying information.

## How it's protected

- Records are linked only to a **random anonymous identifier** — never to your identity.
- Data is transmitted over HTTPS/TLS and stored securely.
- It is used **solely** to improve the product and for research.
