...
It does not require a separate application or any broker API or credentials; it reads NinjaTrader's internal data directly. Once installed, it runs alongside your existing NinjaTrader setup and monitors all connected accounts simultaneously. Once installed, it runs alongside your existing NinjaTrader setup and monitors all connected accounts simultaneously.
